...
import main.view.KnapsackAndScoreFrame;
...
public class MouseInputListener3D implements MouseInputListener {
    ...
    public MouseInputListener3D(Main mm) {
        ...
        try {
            default_cursor = MouseInputListener3D.class.getClassLoader().getResource(IMAGES_PATH +"/arrow.png");
            cross = MouseInputListener3D.class.getClassLoader().getResource(IMAGES_PATH +"/cross.png");
            nw_resize = MouseInputListener3D.class.getClassLoader().getResource(IMAGES_PATH +"/nesw.png");
            sw_resize = MouseInputListener3D.class.getClassLoader().getResource(IMAGES_PATH +"/nwse.png");
            ne_resize = MouseInputListener3D.class.getClassLoader().getResource(IMAGES_PATH +"/nwse.png");
            se_resize = MouseInputListener3D.class.getClassLoader().getResource(IMAGES_PATH +"/nesw.png");
            hand = MouseInputListener3D.class.getClassLoader().getResource(IMAGES_PATH +"/hand.png");
            dot = MouseInputListener3D.class.getClassLoader().getResource(IMAGES_PATH +"/dot.png");
        } catch (Exception ev) {
...
//                    o.updateShape(IMAGES_PATH +"/apple.3ds", 0.03f, e);
//                }
//            }

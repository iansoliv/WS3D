...
import main.CreatureNodeFactory;
import main.IconFactory;
import main.KeyboardWorldInputHandler;
import main.Main;
import main.MouseInputListener3D;
import main.RobotCamera;
import main.view.KnapsackAndScoreFrame;
import main.view.WorldFrame;
import main.view.NewWorldFrame;
...
public class SimulationGameState extends CameraGameState implements ActionListener, MenuListener {
    ...
    public SimulationGameState(String name, Main m, StandardGame game) {
        ...
        Texture texture =
                ...
                IMAGES_PATH +"/checker_medium.jpg"),
    ...
    void createSwingStuff() {
        ...
        JMenuItem newItem;
        JMenuItem exitItem;
        JMenuItem openItem = new JMenuItem("Open", new ImageIcon(IMAGES_PATH +"/open.gif")); // Abrir
        newItem = new JMenuItem(" New", new ImageIcon(IMAGES_PATH +"/new.gif"));   // Limpar
        newItem.setAccelerator(KeyStroke.getKeyStroke(KeyEvent.VK_N, InputEvent.CTRL_MASK));
        openItem.setAccelerator(KeyStroke.getKeyStroke(KeyEvent.VK_O, InputEvent.CTRL_MASK));
        saveItem = new JMenuItem(" Save", new ImageIcon(IMAGES_PATH +"/save.gif"));   // Salvar
        saveItem.setAccelerator(KeyStroke.getKeyStroke(KeyEvent.VK_S, InputEvent.CTRL_MASK));
        exitItem = new JMenuItem(" Exit", new ImageIcon(IMAGES_PATH +"/sair.gif"));
